...
public class Launcher3ModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "Launcher3ModelDelegate";
    ...
    public Launcher3ModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
